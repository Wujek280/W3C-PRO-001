<!--A Design by W3layoutsAuthor: W3layoutAuthor URL: http://w3layouts.comLicense: Creative Commons Attribution 3.0 UnportedLicense URL: http://creativecommons.org/licenses/by/3.0/-->
<!DOCTYPE html>
<?php 
  $nazwa = "NAZWA";
  $firmy = "FIRMY";
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="w3layouts-logo">
						<h1><a href="index.html"> <?php echo $nazwa ?> <span> <?php echo $firmy ?> </span></a></h1>
					</div>
				</div>
						...
						<ul class="slides">
							<li>	
								<div class="banner_text">
									...
									<p>za miaste</p>
									<div class="w3-button">
										<a href="about.html" class="btn btn-1 btn-1b">oferta</a>
									</div>
								</div>
							</li>
						</ul>
